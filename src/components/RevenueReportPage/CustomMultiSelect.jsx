  ...
  return (
    <div className="relative flex-1 rounded h-9 ">
      ...
      <button
        ...
        className="h-9 w-full bg-white rounded border border-[#E0E0E0]  pl-3 text-left text-xs text-[#9D9D9D] pt-[3px] focus:outline-none"
      >
        {selectedOptionsText}
      </button>
      {isOpen && (
        ...
        >
          <div className="p-2">
            ...
            <div className="overflow-y-scroll modal max-h-40 customMultiSelect">
