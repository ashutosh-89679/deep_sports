...
import FilterDropdown from "../components/filters/DelayedFilter.jsx"
...
const DelayedCashflowReportPage = () => {
  // sum of month data
  // sum of month data
  ...
  //console.log("month ->" + month , "year ->" + year, "quarter ->" + quarter);
  ...
  const getData = async () => {
    axios
      .get(
        "https://aarnainfra.com/ladder2/client/cashflow/test.php"
      )
      .then((res) => {
        setData(res?.data);
      });
...
export default DelayedCashflowReportPage  ;