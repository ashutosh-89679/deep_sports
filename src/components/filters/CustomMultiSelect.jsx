...
const CustomMultiSelect = ({ ddName, options, setValue }) => {
  ...
  return (
    <div className="relative rounded shadow filterContainer">
      {/* Button  */}
      <button className="h-8 w-full  rounded border border-[#E0E0E0]  pl-3 text-left text-sm text-[#696969] focus:outline-none">
        {selectedOptionsText}
      </button>
      <div className="absolute z-10 mt-[6px]  shadow w-full rounded border border-[#E0E0E0] bg-white filterContainer">
